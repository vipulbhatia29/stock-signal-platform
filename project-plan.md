...
**Status (Session 116):**
- Plans approved (KAN-465 Done), 3/6 PRs shipped
- PR1 ✅ (PR #242, S114), PR2a ✅ (PR #243, S115), PR2b ✅ (S116, PR TBD)
- Next: PR3 (trace_id middleware)
...
| PR2b | InternalHTTPTarget + `POST /obs/v1/events` ingest endpoint | ~200 | ✅ S116, PR TBD |
